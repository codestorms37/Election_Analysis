...
file_to_save = os.path.join("analysis", "election_analysis_plus.txt")
...
with open(file_to_save, "w") as txt_file:
    ...
    #print(sorted_county_votes)

    # 6a: Write a for loop to get the county from the county dictionary.
    for county in sorted_county_votes:
    ...
    largest_county_summary = (
        ...
        f"Total Votes: {largest_county_votes:,}\n"
        f"Percentage: {largest_county_percentage:.1f}%\n"
        f"-------------------------\n\n\n"
        f"Candidate Results (Sorted):\n\n"
    )
    ...
    for candidate in sorted_candidate_votes:
